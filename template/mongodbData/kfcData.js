...
//     document.getElementById('restaurant_IMG').src = "../img/restaurants/kfc/"+data.restaurant_img
// })

//Getting Recommended Items Data From MongoDB 
fetch('/restaurant/kfcRecommended',{
    method:'get',
    headers:{
        'Content-Type' : 'application/json'
    }
...
.then(data => {
    ...
    image1.src = "../img/restaurants/kfc/"+data[i].item_img
...
//Getting Snacks Data From MongoDB
fetch('/restaurant/kfcSnacks',{
    method:'get',
    headers:{
        'Content-Type' : 'application/json'
    }
...
//    span2.innerHTML = data[i].item_tag
    ...
    newDiv.appendChild(span1)
    newDiv.appendChild(newSubDiv)
    document.getElementById('Snacks').appendChild(newDiv);
        console.log(newDiv)
    }
})
...
//Getting Combo Items Data From MongoDB
fetch('/restaurant/kfcCombos',{
    method:'get',
    headers:{
        'Content-Type' : 'application/json'
    }
...
.then(data => {
    ...
    newDiv.appendChild(span1)
    newDiv.appendChild(newSubDiv)
    document.getElementById('Combos').appendChild(newDiv);
        console.log(newDiv)
    }
})
