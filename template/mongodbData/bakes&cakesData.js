...
//     document.getElementById('restaurant_SideIMG').src = "../img/restaurants/"+data.restaurant__img

// })

//Getting Cakes Data From MongoDB 
fetch('/restaurant/Bakes&CakesCakes',{
    method:'get',
    headers:{
        'Content-Type' : 'application/json'
    }
...
//Getting Rolls Data From MongoDB
fetch('/restaurant/Bakes&CakesRolls',{
    method:'get',
    headers:{
        'Content-Type' : 'application/json'
    }
...
//    span2.innerHTML = data[i].item_tag
    ...
    newDiv.appendChild(span1)
    newDiv.appendChild(newSubDiv)
    document.getElementById('Rolls').appendChild(newDiv);
        console.log(newDiv)
    }
})
...
//Getting Puffs Data From MongoDB
fetch('/restaurant/Bakes&CakesPuffs',{
    method:'get',
    headers:{
        'Content-Type' : 'application/json'
    }
...
.then(data => {
    ...
    newDiv.appendChild(span1)
    newDiv.appendChild(newSubDiv)
    document.getElementById('Puffs').appendChild(newDiv);
        console.log(newDiv)
    }
})
...
//Getting Puffs Data From MongoDB
fetch('/restaurant/Bakes&CakesChocolates',{
    method:'get',
    headers:{
        'Content-Type' : 'application/json'
    }
...
.then(data => {
    ...
    newDiv.appendChild(span1)
    newDiv.appendChild(newSubDiv)
    document.getElementById('Chocolates').appendChild(newDiv);
        console.log(newDiv)
    }
})